...
#define Av3Ind_Pin GPIO_PIN_0
#define Av3Ind_GPIO_Port GPIOA
#define Av2Ind_Pin GPIO_PIN_1
#define Av2Ind_GPIO_Port GPIOA
#define Av1Ind_Pin GPIO_PIN_2
#define Av1Ind_GPIO_Port GPIOA
